                ...
                <form action="{{ route('students.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea name="address" rows="4" cols="16" id="address" name="address" class="form-control"></textarea>
                      </div>
                    <button type="submit" class="btn btn-primary">Submit New Student</button>
                  </form>
            </div>
        </div>
      </div>
